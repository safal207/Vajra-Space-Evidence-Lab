...
| Challenge coverage | 15 | Are negative evidence, contradictions, or alternatives represented? |
| Discriminating path | 10 | Is there a concrete future observation that can distinguish surviving hypotheses? |
...
- SN association: high readiness because it is close to observed/derived evidence.
- shock-breakout interpretation: conditional because model output contributes to the inference.
